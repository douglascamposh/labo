...
class CanalsControllerTest < ActionController::TestCase
  ...
  test "should create canal" do
    assert_difference('Canal.count') do
      post :create, canal: { cantidad: @canal.cantidad, precio: @canal.precio, preciof: @canal.preciof, tamanio: @canal.tamanio, tipo: @canal.tipo }
    end
  ...
  test "should update canal" do
    patch :update, id: @canal, canal: { cantidad: @canal.cantidad, precio: @canal.precio, preciof: @canal.preciof, tamanio: @canal.tamanio, tipo: @canal.tipo }
    assert_redirected_to canal_path(assigns(:canal))
  end
